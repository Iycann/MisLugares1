...
public class LugaresLista implements RepositorioLugares {
    ...
    public int nuevo() {
        Lugar lugar = new Lugar("androidcurso.com", "ciberespacio, 0.0, 0.0", TipoLugar.EDUCACION, 962849300, "http://androidcurso.com", "Amplia tus conocimientos sobre Android.", 5);
        listaLugares.add(lugar);
    ...
    public void añadeEjemplos() {
        ...
        añade(new Lugar("Barranco del Infierno",
                        "Via Verde del río Serpis. Villalonga (Valencia)",
                        -0.295058, 38.867180, 0, "http://sonegaos.blogspot.com.es/2009/02/lorcha-villalonga-via" +
                                "-verde-del-rio.html",
        ...
        añade(new Lugar("La Vital",
                        ...
                        38.9705949, 962881070, "http://www.lavital.en/",
